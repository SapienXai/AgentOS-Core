...
```bash
curl -fsSL https://raw.githubusercontent.com/SapienXai/AgentOS/main/install.sh | AGENTOS_VERSION=0.1.6 bash
```
...
```bash
git tag agentos-v0.1.6
git push origin agentos-v0.1.6
```
